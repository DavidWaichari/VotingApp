...
Route::post('/vote', [App\Http\Controllers\VoterController::class, 'vote'])->name('vote');
Route::get('/candidates/ajax', [App\Http\Controllers\CandidateController::class, 'ajaxFetchCandidates']);
Route::get('/elections/ajax', [App\Http\Controllers\ElectionController::class, 'electionsAjax']);
Route::get('/elections/{id}/ajax', [App\Http\Controllers\ElectionController::class, 'electionsAjaxFetch']);
Route::get('/elections/{id}/has_voted', [App\Http\Controllers\VoterController::class, 'userHasVoted']);
Route::get('/elections/{id}/participate', [App\Http\Controllers\ElectionController::class, 'participate']);
